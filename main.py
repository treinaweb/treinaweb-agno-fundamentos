...
result = job_parser_agent.run("""Logo da empresa BotCity
BotCity
Compartilhar
Exibir mais opções
Java Developer
Brasil · há 1 mês · Mais de 100 pessoas clicaram em Candidatar-se
Respostas gerenciadas fora do LinkedIn


 Remoto
Corresponde às suas preferências de vaga e o tipo de local de trabalho é Remoto.

 Tempo integral
Corresponde às suas preferências de vaga e o tipo de vaga é Tempo integral.

Candidatar-se

Salvar
Salvar Java Developer na BotCity
Java Developer
BotCity · Brasil (Remoto)
...
Salvar Java Developer na BotCity
Exibir mais opções
Veja como você se compara a mais de 100 pessoas que clicaram em Candidate-se
Acesse insights exclusivos sobre candidatos, veja vagas sobre as quais você tem mais chances de receber resposta e muito mais.

Experimente Premium novamente por R$ 0
...
Alyne de Carvalho está contratando
Alyne de Carvalho  
 2º
Tech Recruiter | Headhunter | Psicóloga | People Analyst
4 conexões em comum
...
Experience with version control system tools such as Git and GitHub, CI/CD. Takes ownership end-to-end — from identifying problems to shipping solutions — with a bias for speed,
...
Conquiste seus objetivos mais rapidamente com Premium
Tenha acesso exclusivo a estatísticas sobre candidaturas, veja as vagas que combinam com seu perfil e muito mais




Barroso e outros milhões de usuários têm contas Premium

Experimente Premium novamente por R$ 0
Demonstração gratuita de 1 mês. Fácil de cancelar. Enviaremos um lembrete 7 dias antes do término da demonstração.

Sobre a empresa
Logo da empresa BotCity
BotCity
17.539 seguidores

Seguir
Tecnologia, Informação e Internet  51-200 funcionários  61 no LinkedIn
Somos especialistas em governança de Python há mais de 7 anos e ajudamos grandes empresas a escalar o uso de Python e AI com segurança, controle e confiança.

Nosso objetivo é prepara empresas para operar Python em escala com governança centralizada, controle e visibilidade.

Com o avanço da AI, Python deixou de ser usado apenas por times técnicos e passou a ser criado e executado por usuários de negócio, diretamente nos endpoints corporativos. Esses scripts aceleram operações, mas também introduzem um novo vetor de risco operacional, de segurança e de compliance.

Na maioria das empresas, esse código já está rodando fora da visibilidade de TI e Segurança, sem rastreabilidade, sem auditoria e sem controle efetivo.

Pensando nisso, criamos o BotCity Sentinel. Ele monitora execuções reais de Python nos endpoints após o código já estar em uso, tornando visível o que antes operava fora da governança.

Com isso, empresas passam a identificar Shadow Python, reduzir riscos de vazamento de dados, detectar vulnerabilidades de código e dependências, além de criar evidência concreta de controle para auditorias e requisitos regulatórios.

A BotCity governa o Python onde o risco realmente acontece, na execução real, e não apenas antes da implantação.
…
exibir mais
